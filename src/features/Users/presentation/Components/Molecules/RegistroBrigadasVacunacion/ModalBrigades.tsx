...
function ModalBrigades() {
  ...
  {
    id: 1,
    nombre: "David Reynold Guzmán Castro",
  },
  {
    id: 2,
    nombre: "María Fernanda Morales",
  },
  {
    id: 3,
    nombre: "Luis Antonio Herrera",
  },
  {
    id: 4,
    nombre: "Carla Gómez Castañeda",
  },
  {
    id: 5,
    nombre: "Joel Martínez Robledo",
  },
  {
    id: 6,
    nombre: "Daniela Ramos Rivera",
  },
];
    return ( 
        <>
        ...
        <p className="text-2xl font-semibold text-[#1f3445] ml-5">Agregar enfermero</p>
        <img
            src={x} 
            alt="Cerrar"
